...
async def test_recommendations_empty_library(client, auth_headers):
...
async def test_recommendations_type_filter(client, auth_headers):
...
async def test_recommendations_invalid_type(client, auth_headers):
